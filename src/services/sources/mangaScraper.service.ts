...
export class MangaScraperService implements MangaSource {
  public readonly id = 'manga-scraper';
  public readonly name = 'at0m1cbean manga-scraper';
  public readonly enabled: boolean;
  public readonly supportsSpanish = false;
